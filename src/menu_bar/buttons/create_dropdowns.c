...
void create_dropdowns(sfRenderWindow *window, menu_states *menu, all_dropdowns *dropdowns)
{
    ...
    new_right(window, &dropdowns->edit_dropdown, "eraser", (sfVector2f) {80, 40});

    new_right(window, &dropdowns->help_dropdown, "help", (sfVector2f) {125, 0});
    new_right(window, &dropdowns->help_dropdown, "about", (sfVector2f) {125, 20});
    new_right(window, &dropdowns->help_dropdown, "help", (sfVector2f) {125, 40});
}
